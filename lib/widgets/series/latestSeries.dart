...
class LatestSeries extends StatefulWidget {
  ...
  @override
  _LatestSeriesState createState() => _LatestSeriesState();
}
                    ...
                    children: [
                      Positioned(
                        child: Container(
                            //height: 800,
                            child: Image.network(
                          api.baseURL + api.latestPosters[index],
                          /*height: MediaQuery.of(context).size.height,*/
                        )),
                      ),
                      Positioned(
                ...
                swipeCompleteCallback:
                  ...
                  switch (orientation) {
                    ...
                    case CardSwipeOrientation.RIGHT:
                      api.addLiked(api.latestPosters[index],
                          api.latestTitles[index], api.latestOverviews[index]);
                      print(api.latestTitles[index]);
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Center(
                          child: Text('LIKED!',
                              style: GoogleFonts.getFont('Montserrat').copyWith(
